...
class Wash < Formula
  ...
  bottle do
    root_url "https://github.com/wasmCloud/homebrew-wasmcloud/releases/download/wash-0.32.0"
    sha256 cellar: :any_skip_relocation, monterey: "eadd3744e7aa3ace221cdc7a1f69d5d011258850ce256a2d3d4b016d69c20c98"
  end
